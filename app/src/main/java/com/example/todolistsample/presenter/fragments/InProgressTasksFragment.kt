...
import com.example.todolistsample.databinding.FragmentInProgressTasksBinding
...
class InProgressTasksFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_in_progress_tasks, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        binding = FragmentInProgressTasksBinding.bind(view)
        ...
        mTaskViewModel.getInProgressTasks.observe(viewLifecycleOwner, Observer { task ->
